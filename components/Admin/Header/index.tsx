        ...
        <div className="bg-[#27283C] sm:mx-5 flex items-center justify-between  h-16 rounded-b-xl font-body tracking-wide ">
          <div className="flex ">
            <Image
              ...
              src={NavBtn}
            />
            <p onClick={() => push(ROUTER.ADMIN)} className="sm:ml-5 flex flex-row cursor-pointer items-center text-center font-mukta text-[28px]  font-extrabold text-[#F5F5F5]">
          ...
          <div className="flex gap-5 items-center ">
            ...
            >
              ...
              <span className="hidden tracking-wider font-bold font-poppins text-[10px] md:flex px-1">
                {t("btnProduct")}
              </span>
            </button>
