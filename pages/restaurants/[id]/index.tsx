      ...
      <div className="bg-white dark:bg-black pb-32">
        ...
        <div className="w-full flex items-start py-[3%]  ">
          <div className="w-full md:w-8/12 flex justify-between px-[4%]">
            <div className="w-full bg-[#F3F4F6] dark:bg-gray-900 flex flex-col items-center rounded-[4px]">
              ...
              <div className="max-h-[60vh] min-h-[60vh]  md:max-h-[80vh] md:min-h-[80vh] overflow-y-auto my-scrollable-component w-full">
              ...
              >
                <div className="h-12 w-10/12 cursor-pointer hover:opacity-90 transition-all duration-500 text-center  flex items-center justify-between rounded-[100px] bg-[#D63626] dark:bg-blue-500 text-white  ">
          ...
          <div className="hidden md:w-3/12 rounded-[4px] bg-[#F3F4F6] dark:bg-gray-900 md:flex flex-col items-center">
