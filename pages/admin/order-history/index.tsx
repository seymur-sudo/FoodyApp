...
const OrderHistory: React.FC = () => {
  const { closeUserModal, modalSpring, openUserModal, showUserModal, isAdmin } =
                  ...
                  <div className="w-full md:w-10/12 flex justify-center">
                    ...
                    >
                      ...
                      <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400 font-poppins">
                        <thead className="font-semibold font-poppins text-gray-700 capitalize bg-white dark:bg-gray-700 dark:text-gray-400">
                          <tr>
                          ...
                          {historytems &&
                            historytems?.map((product: any, index: number) => (
                              ...
                              >
                                ...
                                <td className="px-6  text-gray-900 dark:text-white">
                                  {product?.count}
                                </td>
              ...
              <div className=" overflow-x-auto shadow-md ">
                <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                  ...
                  <tbody>
                    {sortedProducts &&
                      sortedProducts.map(
                        (history: OrderPostDataType, index) => (
                          <tr
                            key={history.id}
                          ...
                          >
                            ...
                            <td className="pr-8 py-4  text-gray-900 dark:text-white capitalize">
                              {Moment(history.created).format(
                                "DD-MM-YY - HH:mm:ss"
                              )}
                            </td>

                            <td className="pl-8  text-gray-900 dark:text-white">
                            ...
                            <td className="pl-5 py-4">
                              <div className="flex items-center">
                                <FaEye
                                  onClick={() =>
                                    handleOrderShow(history.products)
                                  }
