...
const LoginPage: React.FC = () => {
  ...
  return (
    <>
      ...
      <main className="bg-white dark:bg-black sm:mr-32px sm:ml-32px" style={{ "zoom": "0.66" }}>
        <ClientHeader />
        <div className="md:flex-row flex-col mx-3 my-3 flex sm:mx-0 ">
          <div className="lg:w-3/6 md:w-[50%] dark:bg-green-900 w-full bg-clientRed lg:h-fit h-[160px] rounded-4 sm:mr-10" data-aos='fade-right'>
            <Image
              alt=""
              width={100}
              height={100}
          ...
          <div className="lg:w-2/6 md:w-[50%] w-full mx-auto" >
            <div className="flex lg:ml-20 flex-row sm:gap-x-16 sm:ml-174px sm:mb-18 sm:mt-105px mt-11 gap-x-9 mb-15 justify-center">
              <p className="text-clientRed dark:text-green-800 sm:text-3xl text-xl font-medium ">
                {t('Login')}
              </p>
              <p onClick={() => router.push('/register')} className="cursor-pointer dark:text-white text-clientGray sm:text-3xl text-xl font-normal sm:mr-48">
                {t('Register')}
              </p>
            </div>
            <div className="">
            ...
            <button className="w-full rounded-5 dark:bg-green-900 text-22 text-white sm:h-68px bg-clientRed font-medium h-14">
             {t('Login')}
            </button>
          </div>
        </div>
